    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal text-white aria-selected:opacity-100 hover:bg-[#2C2C2E]"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-[#00C4B4] text-[#020D0C] hover:bg-[#00C4B4] hover:text-[#020D0C] focus:bg-[#00C4B4] focus:text-[#020D0C]",
        day_today: "bg-[#2C2C2E] text-white",
        day_outside:
        ...
        day_range_middle:
          "aria-selected:bg-[#1C1C1E] aria-selected:text-white",
